...
<main>
    ...
    <section id="sondage_container" data-i="<?= $display->sondage_id ?>">
        ...
        if ($display->status_sondage == 'On' && !$participation) {
            echo "<div class='result'>1 - $display->sondage_question1 : $results->result_1 votes  <input type='radio' name='vote' value='1' id='vote1'> <label for='vote1'>Voter 1</label></div>";
            echo "<div class='result'>2 - $display->sondage_question2 : $results->result_2 votes  <input type='radio' name='vote' value='2' id='vote2'> <label for='vote2'>Voter 2</label></div>";
            echo "<div class='result'>3 - $display->sondage_question3 : $results->result_3 votes  <input type='radio' name='vote' value='3' id='vote3'> <label for='vote3'>Voter 3</label></div>";
            echo "<div class='result'>4 - $display->sondage_question4 : $results->result_4 votes  <input type='radio' name='vote' value='4' id='vote4'> <label for='vote4'>Voter 4</label></div>";
        ...
        if ($display->status_sondage == 'Off' || $participation) {
            echo "<div class='result'>1 - $display->sondage_question1 : $results->result_1 votes</div>";
            echo "<div class='result'>2 - $display->sondage_question2 : $results->result_2 votes  </div>";
            echo "<div class='result'>3 - $display->sondage_question3 : $results->result_3 votes  </div>";
            echo "<div class='result'>4 - $display->sondage_question4 : $results->result_4 votes  </div>";
            echo "<br><p>Nombre de votes : $results->total_entries</p>";
